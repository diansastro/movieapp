...
interface MovieApi {
    ...
    @GET("movie/{movie_id}/reviews?api_key=0f6683dfde9dcd6dd2cca8d62b969728")
    fun getMovieReview(@Path("movie_id") movieId: Int): Observable<Response<MovieReviewResponse>>
